...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      <div className="hero-gradient absolute inset-0 bg-gradient-to-br from-background via-cyan-950/20 to-background bg-[length:200%_200%] z-0"></div>
      <div className="container mx-auto px-4 py-24 z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="hero-title text-4xl md:text-6xl font-bold tracking-tight mb-6">
            ...
            <span className="block bg-gradient-to-r from-primary to-cyan-300 text-transparent bg-clip-text mt-2">
              GatoArtStudio
            </span>
          </h1>
          ...
          <p className="hero-description text-lg md:text-xl text-muted-foreground mb-8">
            Especializado en desarrollo web, aplicaciones de escritorio y desarrollo para Minecraft. Creando soluciones
            digitales con pasión y creatividad.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <Button className="hero-button" variant="outline" size="lg" asChild>
              <a href="mailto:contact@gatoartstudio.art">Contactar</a>
            </Button>
          </div>
